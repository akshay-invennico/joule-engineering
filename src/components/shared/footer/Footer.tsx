      ...
      <div className="container mx-auto px-4 lg:px-8">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center mb-[38px] gap-8">
          ...
          <p className="text-[#808080] font-bold max-w-md">
            Welcome to Joule Engineering Works, where innovation meet our
          ...
          <div className="flex flex-col items-start lg:items-end gap-3">
            ...
            <div className="flex gap-3">
              {[
                {
                  icon: Linkedin,
                  href: 'https://www.linkedin.com/company/joule-engineering-works-halol/',
                },
                { icon: Facebook, href: '#' },
                { icon: Instagram, href: '#' },
                { icon: Twitter, href: '#' },
                ...
                <a
                  key={idx}
                  href={href}
                  className="w-8 h-8 rounded-full border border-[#00AAA5] flex items-center justify-center text-[#00AAA5] hover:bg-[#00AAA5] hover:text-white transition-colors"
                >
                  <Icon size={16} />
                </a>
              ))}
          ...
          <div className="md:border-r md:border-[#E4E4E4] py-10">
            ...
            <div>
              ...
              <p className="text-[#808080] text-sm leading-relaxed">
                SME-1/24, GIDC HALOL MASWAD, BESIDE HERO MOTOCORP, HALOL,
            ...
            <div className="space-y-8">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a
                    href="tel:+8801790224045"
                    className="text-primary font-bold text-lg hover:underline"
                  >
                    9879595031 , 7203000537
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a
                    href="mailto:joule.engg@gmail.com"
                    className="text-primary font-bold text-lg hover:underline"
                  >
                    joule.engg@gmail.com
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a
                    href="https://www.google.com/maps/place/JOULE+ENGINEERING+WORKS/@22.5730231,73.4976138,17z/data=!3m1!4b1!4m6!3m5!1s0x396081b7facc4ba3:0x7433d66c38d96ea9!8m2!3d22.5730231!4d73.5001887!16s%2Fg%2F11p0w2_bl6?entry=ttu&g_ep=EgoyMDI2MDMwMi4wIKXMDSoASAFQAw%3D%3D"
                    className="text-primary font-bold text-lg hover:underline"
                  >
                    Show on Map
                  </a>
