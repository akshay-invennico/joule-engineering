    ...
    <section className="py-16 md:py-24 bg-white">
      <div className="container mx-auto px-4 lg:px-8">
        <div className="mb-12">
          ...
          <h2 className="text-[#0A2540] text-3xl md:text-4xl lg:text-[42px] font-bold leading-tight">
            Industries We Serve
          </h2>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 border-t border-l border-gray-100">
          {industries.map((industry, index) => (
            <div
              key={index}
              className="p-8 border-r border-b border-gray-100 hover:shadow-lg transition-shadow duration-300 bg-white group"
            >
              <div className="text-[#00AAA5] mb-6 group-hover:scale-110 transition-transform duration-300">
                {industry.icon}
              </div>
              <h3 className="text-[#0A2540] text-xl font-bold mb-4 leading-tight">
                {industry.title}
              </h3>
